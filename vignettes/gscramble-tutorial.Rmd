...
with columns `rep`, `pop`, `group`, to indicate which of the founding
...
to map "A" to Pop1 and "B" to Pop2, and in the second rep we might want to map "A" to Pop4, and "B" to
