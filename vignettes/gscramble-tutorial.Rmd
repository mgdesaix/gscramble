...
to check them visually (more on that later...)**.  The package file at:
```{r eval=FALSE}
system.file("extdata/ped-13-complex.csv", package = "gscramble")
```
...
### Matching populations/collections to founding populations. `RepPop`
...
populations ("A", "B", etc.) correspond to the different groups in your genotype data set.
